document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('input', function(e) {
            if (e.target.hasAttribute('required') || e.target.classList.contains('input-error')) {
                clearError(e.target);
            }
        });
    }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '10c4ac0e-6628-4fa6-a12c-0f6e54f8d12a',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '10c4ac0e-6628-4fa6-a12c-0f6e54f8d12a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '10c4ac0e-6628-4fa6-a12c-0f6e54f8d12a';
